...
<template>
      <section class="workspace-view view-scroll">
        ...
        <div class="section-heading"><div><span class="section-kicker">YOUR APPS</span><h3>最近应用</h3><p>继续编辑，或从现有应用快速创建副本。</p></div><button class="subtle-button" @click="state.navigate('home')"><AppIcon name="apps" :size="16" />查看全部</button></div>
