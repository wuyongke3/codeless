...
contextBridge.exposeInMainWorld('lowcode', {
  ...
  publishService: (project: LowCodeProject) => ipcRenderer.invoke('lowcode:publish-service', project),
  stopPublishedService: (projectId: string) => ipcRenderer.invoke('lowcode:stop-published-service', projectId),
  getPublishedServices: () => ipcRenderer.invoke('lowcode:get-published-services'),
